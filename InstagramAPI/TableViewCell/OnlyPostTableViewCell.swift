//
//  OnlyPostTableViewCell.swift
//  OnlyPostTableViewCell
//
...
protocol OnlyPostTableViewCellDelegate: AnyObject {
    func tapCommnet()
    func tapUser()
    func tapLike()
}

class OnlyPostTableViewCell: UITableViewCell {

    static let identifier = "OnlyPostTableViewCell"
    ...
    weak var delegate: OnlyPostTableViewCellDelegate?
    ...
    private func setupLayout() {
        ...
        [wallImage, username, userImage].forEach({$0.isUserInteractionEnabled = true})
        ...
        postPublishTime.anchor(top: tagsLabel.bottomAnchor, bottom: contentView.bottomAnchor, left: postText.leftAnchor, right: postText.rightAnchor, height: 20, topPadding: 5, bottomPadding: 20)
    }
    ...
    override func layoutSubviews() {
        ...
        contentView.layer.addBoard(edge: .bottom, color: .systemGray3, thickness: 0.5)
    }
