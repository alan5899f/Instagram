//
//  OnlyPostCommentTableViewCell.swift
//  OnlyPostCommentTableViewCell
//
...
class OnlyPostCommentTableViewCell: UITableViewCell {

    static let identifier = "OnlyPostCommentTableViewCell"
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        userImage.anchor(top: contentView.topAnchor, left: contentView.leftAnchor, width: 30, height: 30, topPadding: 20, leftPadding: 10)
        ...
        commentPublishTime.anchor(top: commentText.bottomAnchor, bottom: contentView.bottomAnchor, left: commentText.leftAnchor, right: commentText.rightAnchor, bottomPadding: 10)
    }
